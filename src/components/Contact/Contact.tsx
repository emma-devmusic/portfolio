...
const contactItems: ContactItem[] = [
  {
    label: "Email",
    value: "emmanuel@ding.com.ar",
    href: "mailto:emmanuel@ding.com.ar",
    icon: <EmailIcon />,
  },
  {
    label: "Teléfono",
  ...
  },
  {
    ...
    href: "https://www.google.com/maps/search/?api=1&query=Buenos+Aires%2C+Argentina",
    icon: <LocationIcon />,
    external: true,
  },
  {
    label: "LinkedIn",
    value: "linkedin.com/in/emmanuel-dev",
    href: "https://www.linkedin.com/in/emmanuel-dev",
    icon: <LinkedInIcon />,
    external: true,
  },
];
